...
public class TestConfig {
    ...
    public SshTemplate[] sshTemplate() throws IOException {
        ...
        String timestampPosixRegex = env.getProperty("ssh.timestampPosixRegex");
        SshTemplate passwordTemplate = new SshTemplate(passwordSetting, timestampFormat, timestampPosixRegex, rollingLogResolver);
        SshTemplate keyTemplate = new SshTemplate(keySetting, timestampFormat, timestampPosixRegex, rollingLogResolver);
